      ...
      <div className="flex flex-col-reverse md:flex-row justify-between items-center">
        ...
        <div className="md:w-1/2 text-center md:text-left mt-8 md:mt-0">
          ...
          <p className="text-base sm:text-lg md:text-lg text-gray-400 mb-10 mt-8 leading-relaxed">
            I am a full-stack developer with fresher building scalable web
          ...
          {/* Resume Button */}
          <a
            href="https://drive.google.com/file/d/1UCtClwFZPtEG4bP55HYmYSO5qo4wZ2h6/view?usp=drivesdk"
            target="_blank"
            rel="noopener noreferrer"
            className="inline-block text-white py-3 px-8 rounded-full mt-5 text-lg font-bold transition duration-300 transform hover:scale-105"
            style={{
              background: "linear-gradient(80deg, #8245ec, #a855f7)",
              boxShadow: "0 0 1px #8245ec, 0 0 1px #8245ec, 0 0 5px #8245ec",
            }}
          >
            DOWNLOAD CV
          </a>
